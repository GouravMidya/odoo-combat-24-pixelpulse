    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/user/dashboard" element={<UserDashboard userId="667fb866b01dee62d1b43182"/>} />
                <Route path="/signup/create-organization-with-owner" element={<CreateOrganizationWithOwner />} />
                <Route path="/signup/user" element={<UserSignup />} />
                <Route path="/signup/manager" element={<ManagerSignup />} />
                <Route path="/signup/owner" element={<OwnerSignup />} />
                <Route path="/signup" element={<Signup />} />
                <Route path="/manager/dashboard"  element={<Dashboard token="token" />} />
                <Route path="/manager/reservations" element={<Reservations />} />
                <Route path="/manager/maintenance" element={<Maintenance />} />
                <Route path="/user/reservation" element={<ReservationForm facilityId="667fb9d31bcbf5bbb9a7e7da" />}/>
            </Routes>
