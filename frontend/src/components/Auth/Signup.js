...
import { Button, TextField, Grid, Box, Typography, Container, CssBaseline, MenuItem } from '@mui/material';
...
const Signup = () => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            switch (role) {
                case 'Organization':
                    window.location.href = '/signup/organization';
                    break;
                case 'User':
                ...
                case 'Manager':
                    ...
                    break;
                case 'Owner':
                    window.location.href = '/signup/owner';
                    break;
                default:
            ...
            <Container component="main" maxWidth="xs">
                ...
                >
                    ...
                    <Box component="form" onSubmit={handleSignup} noValidate sx={{ mt: 1 }}>
                        ...
                        <Grid container>
                            <Grid item>
                                <Typography align="center" style={{ textAlign: "center" }} alignContent='center'>
